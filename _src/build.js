...
async function buildHTML() {
  try {
    ...
    // Replace the h1 with header structure including bugbear logo
    processedHTML = processedHTML.replace(
      /<h1>([^<]+)<\/h1>/,
      '<div class="header"><h1>$1</h1><img src="imgs/bugbearlogonewblack.gif" alt="Bugbear Logo" class="header-logo"></div>',
    );
    ...
    processedHTML = processedHTML.replace(/<!--end-->/s, "</div>");
